...
<template>
    <el-container class="layout-container">
        ...
        <el-container>
            <!-- 头部区域 -->
            <el-header>
                <div>您的用户昵称为：<strong>{{ adminInfoStore.info.nickname ? adminInfoStore.info.nickname : adminInfoStore.info.username }}
                    </strong></div>
            ...
            <!-- 底部区域 -->
            <el-footer>小项目 ©2025 Created by Xiaojin</el-footer>
        </el-container>
    </el-container>
</template>
